...
public class FoundLiftDetailsActivity extends AppCompatActivity {
    ...
    private void initViews()
    {
        ...
        m_tvDepCity     = findViewById(R.id.card_view_route_stretch_tv_departure_city);
        m_tvDepStreet   = findViewById(R.id.card_view_route_stretch_tv_departure_street);
        m_tvDepDate     = findViewById(R.id.card_view_route_stretch_tv_departure_time);
        m_tvArrCity     = findViewById(R.id.card_view_route_stretch_tv_arrival_city);
        m_tvArrStreet   = findViewById(R.id.card_view_route_stretch_tv_arrival_street);
        m_tvArrDate     = findViewById(R.id.card_view_route_stretch_tv_arrival_time);
